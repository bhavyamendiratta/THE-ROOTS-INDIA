...
<div class="text-center"><a href="collab.html"><button type="submit" title="Send Message" name="send">View More
                </button></a></div>
      </div>
...
<!--
    ...
    <!--==========================
      Contact Section
    ============================-->
    <section id="contact" class="section-bg1" style="background-color: #404040;">
